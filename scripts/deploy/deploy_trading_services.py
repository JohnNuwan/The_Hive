...
SYNC_FILES = [
    ...
    Path("src/eva-banker/eva_banker/__init__.py"),
    Path("src/eva-banker/eva_banker/brain.py"),
    Path("src/eva-banker/eva_banker/debt_manager.py"),
    Path("src/eva-banker/eva_banker/main.py"),
    Path("src/eva-banker/eva_banker/nemesis.py"),
    Path("src/eva-banker/eva_banker/skill_library.py"),
    Path("src/eva-banker/eva_banker/strategist.py"),
    Path("src/eva-banker/eva_banker/swarm.py"),
    Path("src/eva-banker/eva_banker/models/gnn_model.py"),
    Path("src/eva-banker/eva_banker/services/__init__.py"),
    Path("src/eva-banker/eva_banker/services/binance_service.py"),
    Path("src/eva-banker/eva_banker/services/copy_trading.py"),
    Path("src/eva-banker/eva_banker/services/drone_autoscaler.py"),
    Path("src/eva-banker/eva_banker/services/ghost_shield.py"),
    Path("src/eva-banker/eva_banker/services/mt5.py"),
    Path("src/eva-banker/eva_banker/services/multi_account.py"),
    Path("src/eva-banker/eva_banker/services/news_filter.py"),
