...
def deploy():
    print(f"Connecting to Proxmox Server {HOST} to deploy AudioCraft...")
    ...
    try:
        ...
        print("Starting AudioCraft Docker Container...")
        docker_cmd = f"cd ~/The_Hive && echo '{SUDO_PASS}' | sudo -S docker compose -f docker-compose.audiocraft.yml up -d --build"
