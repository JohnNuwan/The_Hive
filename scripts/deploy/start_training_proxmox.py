...
PASSTHROUGH_VARS = [
    ...
    "MUZERO_COLLECTION_NUM_SIMULATIONS_METALS",
    "MUZERO_COLLECTION_NUM_SIMULATIONS_XAUUSD",
    "MUZERO_COLLECTION_NUM_SIMULATIONS_EURUSD",
    ...
    "MUZERO_COLLECTION_MAX_EPISODE_SECONDS_METALS",
    "MUZERO_COLLECTION_MAX_EPISODE_SECONDS_XAUUSD",
    "MUZERO_COLLECTION_MAX_EPISODE_SECONDS_EURUSD",
    "MUZERO_COLLECTION_MAX_MOVES",
    "MUZERO_COLLECTION_MAX_MOVES_METALS",
    "MUZERO_COLLECTION_MAX_MOVES_XAUUSD",
    "MUZERO_COLLECTION_MAX_MOVES_EURUSD",
    ...
    "MUZERO_SOFT_REWARD_MID_END_STEP",
    "MUZERO_SOFT_REWARD_PENALTY_SCALE_EARLY",
    "MUZERO_SOFT_REWARD_PENALTY_SCALE_MID",
    "MUZERO_SOFT_REWARD_PENALTY_SCALE_LATE",
    ...
    "MUZERO_POLICY_PRECHECK_MAX_POST_VETO_RATE",
    ...
    "MUZERO_POLICY_SCREEN_MAX_POST_VETO_RATE",
    "MUZERO_POLICY_SCREEN_MIN_BALANCED_EPISODE_RATE",
    "MUZERO_POLICY_SCREEN_MIN_LONG_ENTRY_SHARE",
    ...
    "MUZERO_ARENA_SCREEN_MIN_SYMBOLS",
    "MUZERO_ARENA_SCREEN_MIN_PROFIT_FACTOR",
...
export MUZERO_COLLECTION_NUM_SIMULATIONS_EURUSD=\"${MUZERO_COLLECTION_NUM_SIMULATIONS_EURUSD:-192}\"
...
export MUZERO_COLLECTION_MAX_EPISODE_SECONDS_EURUSD=\"${MUZERO_COLLECTION_MAX_EPISODE_SECONDS_EURUSD:-180}\"
...
export MUZERO_COLLECTION_MAX_MOVES_EURUSD=\"${MUZERO_COLLECTION_MAX_MOVES_EURUSD:-96}\"
...
docker compose run --rm \
  ...
  -e MUZERO_COLLECTION_NUM_SIMULATIONS_METALS=\"$MUZERO_COLLECTION_NUM_SIMULATIONS_METALS\" \
  -e MUZERO_COLLECTION_NUM_SIMULATIONS_XAUUSD=\"$MUZERO_COLLECTION_NUM_SIMULATIONS_XAUUSD\" \
  -e MUZERO_COLLECTION_NUM_SIMULATIONS_EURUSD=\"$MUZERO_COLLECTION_NUM_SIMULATIONS_EURUSD\" \
  -e MUZERO_COLLECTION_MAX_MOVES=\"$MUZERO_COLLECTION_MAX_MOVES\" \
  -e MUZERO_COLLECTION_MAX_MOVES_METALS=\"$MUZERO_COLLECTION_MAX_MOVES_METALS\" \
  -e MUZERO_COLLECTION_MAX_MOVES_XAUUSD=\"$MUZERO_COLLECTION_MAX_MOVES_XAUUSD\" \
  -e MUZERO_COLLECTION_MAX_MOVES_EURUSD=\"$MUZERO_COLLECTION_MAX_MOVES_EURUSD\" \
  -e MUZERO_COLLECTION_MAX_EPISODE_SECONDS_METALS=\"$MUZERO_COLLECTION_MAX_EPISODE_SECONDS_METALS\" \
  -e MUZERO_COLLECTION_MAX_EPISODE_SECONDS_XAUUSD=\"$MUZERO_COLLECTION_MAX_EPISODE_SECONDS_XAUUSD\" \
  -e MUZERO_COLLECTION_MAX_EPISODE_SECONDS_EURUSD=\"$MUZERO_COLLECTION_MAX_EPISODE_SECONDS_EURUSD\" \
