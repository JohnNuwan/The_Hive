"""
Configuration CentralisÃ©e - THE HIVE
...
class Settings(BaseSettings):
    ...
    # EAGLE-3 Speculative Decoding (latence Ã·3)
    ...
    mock_mt5: bool = True  # True pour dev sans MT5 rÃ©el
    ...
    # â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
    # EVA LAB (Feature Flags â€” Sprint 5)
    # â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
    enable_dreamer_training: bool = True       # RTX 3090 only â€” active DreamerV3 training
    enable_shadow_learning: bool = True        # Collecte passive des donnÃ©es pour DreamerV3
    shadow_learning_buffer_size: int = 10000   # Nombre max de transitions en mÃ©moire
    shadow_learning_flush_interval: int = 300  # Flush sur disque toutes les N secondes

    # Constitution Loi 0 - Seuils tempÃ©rature
    ...
    # â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
    # COMFYUI (Image/Video Generation â€” GPU Server)
    # â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
...
def get_settings() -> Settings:
    """Retourne une instance cachÃ©e des settings"""
    return Settings()
