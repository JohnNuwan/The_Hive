    ...
    def _build_blocked_live_response(
        ...
        *,
        ...
        return {
            ...
            "artifact_compatibility": dict(checkpoint_meta.get("artifact_compatibility") or {}),
            "checkpoint_schema_version": checkpoint_meta.get("checkpoint_schema_version"),
            "resume_source": checkpoint_meta.get("resume_source"),
            "lineage": dict(checkpoint_meta.get("lineage") or {}),
            "seed_parent_champion_id": checkpoint_meta.get("seed_parent_champion_id"),
            "ga_campaign_id": checkpoint_meta.get("ga_campaign_id"),
            "ga_trial": checkpoint_meta.get("ga_trial"),
            "simulations": 0,
