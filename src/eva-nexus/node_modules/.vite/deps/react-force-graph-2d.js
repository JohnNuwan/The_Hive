...
function _(l2, u2, t5) {
  ...
  return m(l2, e3, i2, o2, null);
}
function m(n2, t5, i2, o2, r2) {
...
function $() {
  for (var n2, u2, t5, o2, r2, f2, c5, s2 = 1; i.length; ) i.length > s2 && i.sort(e), n2 = i.shift(), s2 = i.length, n2.__d && (t5 = void 0, o2 = void 0, r2 = (o2 = (u2 = n2).__v).__e, f2 = [], c5 = [], u2.__P && ((t5 = w({}, o2)).__v = o2.__v + 1, l.vnode && l.vnode(t5), O(u2.__P, t5, o2, u2.__n, u2.__P.namespaceURI, 32 & o2.__u ? [r2] : null, f2, null == r2 ? S(o2) : r2, !!(32 & o2.__u), c5), t5.__v = o2.__v, t5.__.__k[t5.__i] = t5, N(f2, t5, c5), o2.__e = o2.__ = null, t5.__e != r2 && C2(t5)));
  $.__r = 0;
}
function I(n2, l2, u2, t5, i2, o2, r2, e3, f2, c5, s2) {
  var a3, h2, y3, d2, w2, g2, _2, m3 = t5 && t5.__k || v, b = l2.length;
  for (f2 = P(u2, l2, m3, f2, b), a3 = 0; a3 < b; a3++) null != (y3 = u2.__k[a3]) && (h2 = -1 == y3.__i ? p : m3[y3.__i] || p, y3.__i = a3, g2 = O(n2, y3, h2, i2, o2, r2, e3, f2, c5, s2), d2 = y3.__e, y3.ref && h2.ref != y3.ref && (h2.ref && B2(h2.ref, null, y3), s2.push(y3.ref, y3.__c || d2, y3)), null == w2 && null != d2 && (w2 = d2), (_2 = !!(4 & y3.__u)) || h2.__k === y3.__k ? f2 = A2(y3, f2, n2, _2) : "function" == typeof y3.type && void 0 !== g2 ? f2 = g2 : d2 && (f2 = d2.nextSibling), y3.__u &= -7);
  return u2.__e = w2, f2;
}
function P(n2, l2, u2, t5, i2) {
  var o2, r2, e3, f2, c5, s2 = u2.length, a3 = s2, h2 = 0;
  for (n2.__k = new Array(i2), o2 = 0; o2 < i2; o2++) null != (r2 = l2[o2]) && "boolean" != typeof r2 && "function" != typeof r2 ? ("string" == typeof r2 || "number" == typeof r2 || "bigint" == typeof r2 || r2.constructor == String ? r2 = n2.__k[o2] = m(null, r2, null, null, null) : d(r2) ? r2 = n2.__k[o2] = m(k, { children: r2 }, null, null, null) : void 0 === r2.constructor && r2.__b > 0 ? r2 = n2.__k[o2] = m(r2.type, r2.props, r2.key, r2.ref ? r2.ref : null, r2.__v) : n2.__k[o2] = r2, f2 = o2 + h2, r2.__ = n2, r2.__b = n2.__b + 1, e3 = null, -1 != (c5 = r2.__i = L(r2, u2, f2, a3)) && (a3--, (e3 = u2[c5]) && (e3.__u |= 2)), null == e3 || null == e3.__v ? (-1 == c5 && (i2 > s2 ? h2-- : i2 < s2 && h2++), "function" != typeof r2.type && (r2.__u |= 4)) : c5 != f2 && (c5 == f2 - 1 ? h2-- : c5 == f2 + 1 ? h2++ : (c5 > f2 ? h2-- : h2++, r2.__u |= 4))) : n2.__k[o2] = null;
...
function L(n2, l2, u2, t5) {
  var i2, o2, r2, e3 = n2.key, f2 = n2.type, c5 = l2[u2], s2 = null != c5 && 0 == (2 & c5.__u);
  if (null === c5 && null == e3 || s2 && e3 == c5.key && f2 == c5.type) return u2;
  if (t5 > (s2 ? 1 : 0)) {
    for (i2 = u2 - 1, o2 = u2 + 1; i2 >= 0 || o2 < l2.length; ) if (null != (c5 = l2[r2 = i2 >= 0 ? i2-- : o2++]) && 0 == (2 & c5.__u) && e3 == c5.key && f2 == c5.type) return r2;
  }
  return -1;
}
function T(n2, l2, u2) {
...
function j(n2, l2, u2, t5, i2) {
  ...
  else if ("o" == l2[0] && "n" == l2[1]) o2 = l2 != (l2 = l2.replace(f, "$1")), r2 = l2.toLowerCase(), l2 = r2 in n2 || "onFocusOut" == l2 || "onFocusIn" == l2 ? r2.slice(2) : l2.slice(2), n2.l || (n2.l = {}), n2.l[l2 + o2] = u2, u2 ? t5 ? u2.u = t5.u : (u2.u = c, n2.addEventListener(l2, o2 ? a : s, o2)) : n2.removeEventListener(l2, o2 ? a : s, o2);
  else {
...
function O(n2, u2, t5, i2, o2, r2, e3, f2, c5, s2) {
  var a3, h2, p2, v2, y3, _2, m3, b, S2, C3, M2, $2, P2, A3, H, L2, T2, j2 = u2.type;
  if (void 0 !== u2.constructor) return null;
  128 & t5.__u && (c5 = !!(32 & t5.__u), r2 = [f2 = u2.__e = t5.__e]), (a3 = l.__b) && a3(u2);
  n: if ("function" == typeof j2) try {
    if (b = u2.props, S2 = "prototype" in j2 && j2.prototype.render, C3 = (a3 = j2.contextType) && i2[a3.__c], M2 = a3 ? C3 ? C3.props.value : a3.__ : i2, t5.__c ? m3 = (h2 = u2.__c = t5.__c).__ = h2.__E : (S2 ? u2.__c = h2 = new j2(b, M2) : (u2.__c = h2 = new x(b, M2), h2.constructor = j2, h2.render = E2), C3 && C3.sub(h2), h2.state || (h2.state = {}), h2.__n = i2, p2 = h2.__d = true, h2.__h = [], h2._sb = []), S2 && null == h2.__s && (h2.__s = h2.state), S2 && null != j2.getDerivedStateFromProps && (h2.__s == h2.state && (h2.__s = w({}, h2.__s)), w(h2.__s, j2.getDerivedStateFromProps(b, h2.__s))), v2 = h2.props, y3 = h2.state, h2.__v = u2, p2) S2 && null == j2.getDerivedStateFromProps && null != h2.componentWillMount && h2.componentWillMount(), S2 && null != h2.componentDidMount && h2.__h.push(h2.componentDidMount);
    else {
    ...
    h2.state = h2.__s, null != h2.getChildContext && (i2 = w(w({}, i2), h2.getChildContext())), S2 && !p2 && null != h2.getSnapshotBeforeUpdate && (_2 = h2.getSnapshotBeforeUpdate(v2, y3)), L2 = a3, null != a3 && a3.type === k && null == a3.key && (L2 = V(a3.props.children)), f2 = I(n2, d(L2) ? L2 : [L2], u2, t5, i2, o2, r2, e3, f2, c5, s2), h2.base = u2.__e, u2.__u &= -161, h2.__h.length && e3.push(h2), m3 && (h2.__E = h2.__ = null);
  } catch (n3) {
  ...
  else null == r2 && u2.__v == t5.__v ? (u2.__k = t5.__k, u2.__e = t5.__e) : f2 = u2.__e = q(t5.__e, u2, t5, i2, o2, r2, e3, c5, s2);
...
function q(u2, t5, i2, o2, r2, e3, f2, c5, s2) {
  ...
  if (null == x3) b === k2 || c5 && u2.data == k2 || (u2.data = k2);
    ...
    for (a3 in k2) w2 = k2[a3], "children" == a3 ? y3 = w2 : "dangerouslySetInnerHTML" == a3 ? h2 = w2 : "value" == a3 ? _2 = w2 : "checked" == a3 ? m3 = w2 : c5 && "function" != typeof w2 || b[a3] === w2 || j(u2, a3, w2, b[a3], r2);
    if (h2) c5 || v2 && (h2.__html == v2.__html || h2.__html == u2.innerHTML) || (u2.innerHTML = h2.__html), t5.__k = [];
    else if (v2 && (u2.innerHTML = ""), I("template" == t5.type ? u2.content : u2, d(y3) ? y3 : [y3], t5, i2, o2, "foreignObject" == x3 ? "http://www.w3.org/1999/xhtml" : r2, e3, f2, e3 ? e3[0] : i2.__k && S(i2, 0), c5, s2), null != e3) for (a3 = e3.length; a3--; ) g(e3[a3]);
...
function G(u2, t5, i2) {
  var o2, r2, e3, f2;
  t5 == document && (t5 = document.documentElement), l.__ && l.__(u2, t5), r2 = (o2 = "function" == typeof i2) ? null : i2 && i2.__k || t5.__k, e3 = [], f2 = [], O(t5, u2 = (!o2 && i2 || t5).__k = _(k, null, [u2]), r2 || p, p, t5.namespaceURI, !o2 && i2 ? [i2] : r2 ? null : t5.firstChild ? n.call(t5.childNodes) : null, e3, !o2 && i2 ? i2 : r2 ? r2.__e : t5.firstChild, o2, f2), N(e3, u2, f2);
}
function K2(l2, u2, t5) {
  var i2, o2, r2, e3, f2 = w({}, l2.props);
  for (r2 in l2.type && l2.type.defaultProps && (e3 = l2.type.defaultProps), u2) "key" == r2 ? i2 = u2[r2] : "ref" == r2 ? o2 = u2[r2] : f2[r2] = void 0 === u2[r2] && null != e3 ? e3[r2] : u2[r2];
  return arguments.length > 2 && (f2.children = arguments.length > 3 ? n.call(arguments, 2) : t5), m(l2.type, f2, i2 || l2.key, o2 || l2.ref, null);
}
